...
$query = "INSERT INTO productos (nombre_producto, imagen_producto, descripcion_producto, stock_producto, precio_producto) VALUES ('$nombre', '$imagen', '$descripcion', '$stock', '$precio');";
